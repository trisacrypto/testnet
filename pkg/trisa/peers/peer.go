...
type Peer struct {
	...
	stream protocol.TRISANetwork_TransferStreamClient // NOTE: currently unused
}
...
func (p *Peer) Transfer(in *protocol.SecureEnvelope) (out *protocol.SecureEnvelope, err error) {
...
func (p *Peer) connect() (err error) {
	...
	p.client = protocol.NewTRISANetworkClient(cc)
	return nil
}
