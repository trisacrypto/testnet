...
const (
	...
	TransactionState_AWAITING             TransactionState = 1
	TransactionState_PENDING_SENT         TransactionState = 2
	TransactionState_PENDING_ACKNOWLEDGED TransactionState = 3
	TransactionState_ACCEPTED             TransactionState = 4
	TransactionState_FAILED               TransactionState = 5
	TransactionState_EXPIRED              TransactionState = 6
	TransactionState_COMPLETED            TransactionState = 7
)
