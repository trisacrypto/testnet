...
class TRISADemo(object):
    ...
    def LiveUpdates(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/rvasp.v1.TRISADemo/LiveUpdates',
...
class TRISAIntegration(object):
    ...
    def Transfer(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/rvasp.v1.TRISAIntegration/Transfer',
    ...
    def AccountStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/rvasp.v1.TRISAIntegration/AccountStatus',
